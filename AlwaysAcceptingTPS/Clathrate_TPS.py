...
def test_openmm_SPEx_sample():
    ...
    base_path = f"data_mu175_chain0_batch_4new"
    ...
    # initial_traj_folder = '/leonardo_work/L-AUT_Coretti/CODE/ClathrateTPS/InitialTrajectories/data_mu175_chain1_batch_2_last'
    initial_traj_folder = '/leonardo_work/L-AUT_Coretti/CODE/AlwaysAcceptingClathrates/InitialTrajectories/data_mu175_chain0_batch_3_last' 
    initial_traj_idx = 20
